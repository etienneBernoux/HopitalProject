...
public class TestAll {
    ...
    public void testCreate() {
        ...
        if(test)System.out.println("Création de "+infirmier.toString());
    ...
    public void testdelete() {
        ...
        if(test)System.out.println("Supression de "+infirmier.toString());
    }
    ...
    public void testupdate() {
        ...
        if(test)System.out.println("Mise à jour de "+batiment.toString());
        //Test de chambre
        Chambre chambre = new Chambre("REA", 109, 22, 3);
        DAO<Chambre> chambreDAO = new ChambreDAO(ConnectionEce.getConn());
        test=chambreDAO.update(chambre);
        if(test)System.out.println("Mise à jour de "+chambre.toString());
        //Test de docteur
        ...
        if(test)System.out.println("Mise à jour de "+docteur.toString());
        //Test de employe
        ...
        if(test)System.out.println("Mise à jour de "+employe.toString());
        //Test de hospitalisation
        Hospitalisation hospitalisation=new Hospitalisation(13,"REA", 106,1);
        DAO<Hospitalisation> hosDAO = new HospitalisationDAO(ConnectionEce.getConn());
        test=hosDAO.update(hospitalisation);
        if(test)System.out.println("Mise à jour de "+hospitalisation.toString());
        //Test de infirmier
        ...
        if(test)System.out.println("Mise à jour de "+infirmier.toString());

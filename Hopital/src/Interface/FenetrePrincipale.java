...
public class FenetrePrincipale  extends JFrame implements ActionListener {
  ...
  private JButton searchButton= new JButton("Recherche"), readMe = new JButton("Aide");
  private JButton majButton= new JButton(""), statButton= new JButton("");
  ...
  public FenetrePrincipale(String id1, String mdp1, String id2, String mdp2) throws SQLException{
      idECE = id1; mdpECE = mdp1; idSQL = id2; mdpSQL = mdp2;
